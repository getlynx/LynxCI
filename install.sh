...
#
firewallService="/etc/systemd/system/lyf.service" # This service resets the local iptables.
rm -rf $firewallService
if [ ! -O $firewallService ]; then
echo "#!/bin/bash
[Unit]
Description=lyf
After=network.target
